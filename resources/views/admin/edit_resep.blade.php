                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" value="{{$resep->deskripsi}}" autocomplete="off" type="text" name="deskripsi" placeholder="Berikan deskripsi makanannya..."></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" value="{{$resep->resep}}" autocomplete="off" name="resep" placeholder="Apa aja bahan yang dibutuhkan...."></textarea>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label font-weight-bolder">Langkah membuat Masakan</label>
                        <textarea class="form-control" value="{{$resep->cara_buat}}" autocomplete="off" name="cara_buat" placeholder="Bagaimana cara buatnya...."></textarea>
                      </div>
                    </div>
                  </div>
                    <div class="row">
